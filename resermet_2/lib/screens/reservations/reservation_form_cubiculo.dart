...
class _ReservationFormCubiculoState extends State<ReservationFormCubiculo> {
  ...
  // Método _selectTime (Usa tu picker original)
  ...
  // --- MÉTODO _submitReservation MODIFICADO (Lógica rápida) ---
  Future<void> _submitReservation() async {
    ...
    try {
      // Lógica de creación de reserva (sin cambios)
  ...
  Widget build(BuildContext context) {
    // --- UI (sin cambios, excepto el botón) ---
    return SizedBox(
